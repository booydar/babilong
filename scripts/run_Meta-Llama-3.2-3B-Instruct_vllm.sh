...
MODEL_PATH="/home/jovyan/kuratov/models/Llama-3.2-3B-Instruct"
...
# CUDA_VISIBLE_DEVICES=0,1 vllm serve ./Llama-3.2-3B-Instruct --enable-chunked-prefill=False --tensor-parallel-size 2 \
