...
class NoiseInjectionDataset(Dataset):
    ...
    def __getitem__(self, ind):
        ...
        facts = [' ' + f for f in sample['facts']]
        question = ' ' + sample['question']
        facts_tok = self.tokenizer(facts, add_special_tokens=False)['input_ids']
        question_tok = self.tokenizer(question, add_special_tokens=False)['input_ids']
