...
MODEL_CPTS=(
    ...
    "/home/jovyan/rmt/runs/test//Llama-3.2-1B-Instruct/dolly:qa1-5-1:9/SEGM_4x1024_4032_64-LR1e-05-lora-mnc-distill_1.0/checkpoint-500/pytorch_model.bin" \
    "/home/jovyan/rmt/runs/test//Llama-3.2-1B-Instruct/dolly:qa1-5-1:9/SEGM_4x1024_4032_64-LR1e-05-lora-mnc-distill_1.0/checkpoint-8000/pytorch_model.bin" \
)
...
MODEL_TITLES=(
    ...
    "armt-llama3.2-1b-4x1024-LR1e-05-smol:qa1-5-1:9-distill_1.0"\
    "armt-llama3.2-1b-4x1024-LR1e-05-smol:qa1-5-1:9-distill_1.0-last"\
)
