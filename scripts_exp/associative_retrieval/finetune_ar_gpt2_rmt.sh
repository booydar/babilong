...
python create_config_gpt2.py --hidden_size $DIM --num_hidden_layers $NUM_LAYERS --num_attention_heads $NUM_LAYERS
cd ../..
MODEL_CFG=/home/jovyan/rmt/wip/base_models/gptconfigs/gpt2_tiny_${NUM_LAYERS}l${NUM_LAYERS}hd${DIM}.json
