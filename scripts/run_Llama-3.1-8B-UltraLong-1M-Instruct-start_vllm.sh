...
MODEL_PATH="/home/jovyan/kuratov/models/Llama-3.1-8B-UltraLong-1M-Instruct"
...
vllm serve "$MODEL_PATH" --enable-chunked-prefill=False --tensor-parallel-size $TP \
    ...
    --max_model_len 1073152 --dtype bfloat16 &
#--max_model_len 1073152 &
