...
MODEL_CPTS=(
    "/home/jovyan/rmt/runs/test/babilong_multitask/meta-llama/Llama-3.2-1B-Instruct/lr_3e-04_d64_cosine_adamw_wd1e-03_2x1024_mem16_bs64_bptt--1_from_cpt_0-2_lora_ct-v3-rlls/run_2/checkpoint-2000/pytorch_model.bin" \
...
MODEL_TITLES=(
    "test/armt-llama3.2-1b-2x1024-ct-v3-lora-rlls-eval-rlls-2-2k_iter" \
    # "armt-llama3.2-1b-4x1024-ct-v3-lora" \
    # "armt-llama3.2-1b-8x1024-ct-v3-lora" \
)
