...
MODEL_CPTS=(
    ...
    "/home/jovyan/rmt/runs/test//Llama-3.2-1B-Instruct/dolly:qa1-5-1:9/SEGM_8x1024_8064_64-LR1e-05-lora-mnc-distill_1.0/checkpoint-500/pytorch_model.bin" \
)
...
MODEL_TITLES=(
    ...
    "armt-llama3.2-1b-8x1024-LR1e-05-smol:qa1-5-1:9-distill_1.0"\
)
