...
RECURRENT_WRAPPER=modeling_amt.experimental:AssociativeRecurrentWrapperDisableLoRALS
...
MAX_N_SEGMENTSS=(0 2 4 8 16 32)
BSS=(4 4 4 2 2 1 1)

# MAX_N_SEGMENTSS=(2 4 8 16 32)
# BSS=(4 2 2 1 1 1)
...
accelerate launch --config_file $ACCEL_CONFIG --main_process_port 29006 run_finetuning_babilong_armt_hf_trainer_ct.py \
        --task_dataset $TASK_DATASET \
        --noise_dataset $NOISE_DATASET \
        --babi_path /home/jovyan/rmt/babilong/data/tasks_1-20_v1-2/en-10k \
        --output_dir /home/jovyan/rmt/runs/test/babilong_multitask/$MODEL_NAME/lr_${LR}_d${D_MEM}_${SCHEDULER}_adamw_wd1e-03_${MAX_N_SEGMENTS}x${SEGMENT_SIZE}_mem${MEMORY_SIZE}_bs${TBS}_bptt-${K2}_from_cpt_${SRC_N_SEGMENTS}-${MAX_N_SEGMENTS}_lora_ct-v3-rlls/run_$N \
        --model_cpt /home/jovyan/rmt/runs/test/babilong_multitask/$MODEL_NAME/lr_3e-04_d${D_MEM}_${SCHEDULER}_adamw_wd1e-03_${SRC_N_SEGMENTS}x${SEGMENT_SIZE}_mem${MEMORY_SIZE}_bs${TBS}_bptt-${K2}_from_cpt_${SRC_SRC_N_SEGMENTS}-${SRC_N_SEGMENTS}_lora_ct-v3-rlls/run_$N \
