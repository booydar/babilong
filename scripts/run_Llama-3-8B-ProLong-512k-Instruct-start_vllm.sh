...
MODEL_PATH="/home/jovyan/kuratov/models/Llama-3-8B-ProLong-512k-Instruct"

# Start the vLLM server in the background
# Comment this section if vLLM server is already running.
# 2xA100 80GB, vllm 0.8.4
...
vllm serve "$MODEL_PATH" --enable-chunked-prefill=False --tensor-parallel-size $TP \
    ...
    --max_model_len 524288 --dtype bfloat16 &
...
TASKS=("qa1" "qa2" "qa3" "qa4" "qa5")
LENGTHS=("32k" "0k" "1k" "2k" "4k" "8k" "16k")
