...
MODEL_CPTS=(
    "/home/jovyan/rmt/runs/test/Llama-3.2-1B/qa1-5-90:/SEGM_2x1024_2016_64-lora/checkpoint-2000/pytorch_model.bin" \
)

MODEL_TITLES=(
    "armt-llama3.2-1b-base-2x1024-dolly:qa1-5-9:1"\
)
