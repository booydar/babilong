...
python run_finetuning_associative_retrieval.py \
        ...
        --model_cpt ../runs/test/${TASK_NAME}/$MODEL_NAME/lr3e-04_${SCHEDULER}_adamw_wd1e-03_k2-v${VALUE_SIZE}-p${NUM_PAIRS}-${MAX_N_SEGMENTS}x${INPUT_SIZE}_mem${MEMORY_SIZE}_bs${TBS}_${SEGMENT_ORDERING}_bptt-${K2}_${NUM_LAYERS}l${NUM_LAYERS}hd${DIM}/run_1 \
        --model_cfg $MODEL_CFG \
