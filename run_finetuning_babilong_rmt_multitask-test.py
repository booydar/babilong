...
# load_dotenv()
from babilong_utils import MultiTaskDataset, SentenceSampler, NoiseInjectionDataset
    ...
    if args.num_mem_tokens is not None:
        ...
        if args.model_cpt:
            ...
            if os.path.exists(model_cpt):
                ...
                # model_cpt = os.path.join(args.model_cpt, "accelerate_state/pytorch_model/mp_rank_00_model_states.pt")
            else:
                import safetensors
