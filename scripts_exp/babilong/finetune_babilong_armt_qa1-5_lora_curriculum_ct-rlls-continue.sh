...
accelerate launch --config_file $ACCEL_CONFIG --main_process_port 29006 run_finetuning_babilong_armt_hf_trainer_ct.py \
        ...
        --checkpoint /home/jovyan/rmt/runs/test/babilong_multitask/meta-llama/Llama-3.2-1B-Instruct/lr_3e-04_d64_cosine_adamw_wd1e-03_4x1024_mem16_bs64_bptt--1_from_cpt_2-4_lora_ct-v3-rlls/run_1/checkpoint-2000 \
