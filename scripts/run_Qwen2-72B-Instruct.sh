...
# up to 16k
# CUDA_VISIBLE_DEVICES=0,1,2,3 vllm serve ./Qwen2-72B-Instruct --served-model-name Qwen/Qwen2-72B-Instruct \
# --enable-chunked-prefill=False --tensor-parallel-size 4 --gpu-memory-utilization 0.99 --max_model_len 32768 \
# --trust_remote_code --enforce_eager

# 32k, 64k update model config with (as recommended in https://huggingface.co/Qwen/Qwen2-72B-Instruct)
# "rope_scaling": {
#             "factor": 4.0,
#             "original_max_position_embeddings": 32768,
#             "type": "yarn"
#         }
# VLLM_ENGINE_ITERATION_TIMEOUT_S=300 CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 vllm serve ./Qwen2-72B-Instruct \
# --served-model-name Qwen/Qwen2-72B-Instruct --enable-chunked-prefill=False --tensor-parallel-size 8 \
...
#             "type": "yarn"
#         }
# VLLM_ENGINE_ITERATION_TIMEOUT_S=3000 CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 vllm serve ./Qwen2-72B-Instruct
# --served-model-name Qwen/Qwen2-72B-Instruct --enable-chunked-prefill=False --tensor-parallel-size 8 \
