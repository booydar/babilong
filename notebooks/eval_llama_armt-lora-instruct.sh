...
MODEL_TITLES=(
    ...
    # "armt-llama3.2-1b-2x1024-ct-v3-lora-instruct" \
    # "armt-llama3.2-1b-4x1024-ct-v3-lora-instruct" \
    "armt-llama3.2-1b-8x1024-ct-v3-lora-instruct-examples" \
)
...
#     # "armt-llama3.2-1b-2x1024-ct-v3-lora-instruct" \
#     # "armt-llama3.2-1b-4x1024-ct-v3-lora-instruct" \
#     "armt-llama3.2-1b-8x1024-ct-v3-lora-instruct" \
# )
