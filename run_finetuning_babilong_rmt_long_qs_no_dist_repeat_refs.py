...
# load_dotenv()
from babilong_utils import SentenceSampler, NoiseInjectionDataset
from babilong_utils_exp import TaskDatasetRepeatReferences as TaskDataset
...
if __name__ == '__main__':
    ...
    task_dataset_train = TaskDataset(train_path, max_n_facts=args.max_n_facts, no_distractors=True)
    task_dataset_test = TaskDataset(test_path, max_n_facts=args.max_n_facts, no_distractors=True)
