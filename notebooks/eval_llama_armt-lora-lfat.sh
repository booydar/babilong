...
MODEL_CPTS=(
    # "/home/jovyan/rmt/runs/test/babilong_multitask/meta-llama/Llama-3.2-1B-Instruct/lr_3e-04_d64_linear_adamw_wd1e-03_1x1024_mem16_bs64_bptt--1_from_cpt_0-1_lora_ct-v3-lfat/run_1/checkpoint-12000/pytorch_model.bin" \
    "/home/jovyan/rmt/runs/test/babilong_multitask/meta-llama/Llama-3.2-1B-Instruct/lr_3e-04_d64_linear_adamw_wd1e-03_2x1024_mem16_bs64_bptt--1_from_cpt_1-2_lora_ct-v3-lfat/run_1/checkpoint-1000/pytorch_model.bin" \
...
MODEL_TITLES=(
    # "armt-llama3.2-1b-1x1024-ct-v3-lora-lfat" \
    "armt-llama3.2-1b-2x1024-ct-v3-lora-lfat" \
    # "armt-llama3.2-1b-4x1024-ct-v3-lora-lfat" \
    # "armt-llama3.2-1b-8x1024-ct-v3-lora-lfat" \
)
