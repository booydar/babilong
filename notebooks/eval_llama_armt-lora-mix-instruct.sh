...
MODEL_CPTS=(
    "/home/jovyan/rmt/runs/test/Llama-3.2-1B-Instruct/dolly:qa1-5-1:9/SEGM_2x1024_2016_64-lora-mnc/checkpoint-1500/pytorch_model.bin" \
)

MODEL_TITLES=(
    "armt-llama3.2-1b-2x1024-dolly:qa1-5-1:9"\
)
