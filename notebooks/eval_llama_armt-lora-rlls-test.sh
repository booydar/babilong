...
RECURRENT_WRAPPER=modeling_amt.experimental:AssociativeRecurrentWrapper
...
MODEL_CPTS=(
    ...
    "/home/jovyan/rmt/runs/test/babilong_multitask/meta-llama/Llama-3.2-1B-Instruct/lr_3e-04_d64_cosine_adamw_wd1e-03_4x1024_mem16_bs64_bptt--1_from_cpt_2-4_lora_ct-v3-rlls/run_1/checkpoint-22000/pytorch_model.bin" \
...
MODEL_TITLES=(
    # "test/armt-llama3.2-1b-2x1024-ct-v3-lora-rlls-eval-ells" \
    "test/armt-llama3.2-1b-4x1024-ct-v3-lora-rlls-eval-ells" \
)
...
python run_rmt_model_on_babilong_custom.py \
